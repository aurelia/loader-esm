...
export declare function ensureOriginOnExports(moduleExports: Record<string, any>, moduleId: string): Record<string, any>;
/**
* A default implementation of the Loader abstraction which works with webpack (extended common-js style).
*/
export declare class EsmLoader extends Loader {
	moduleRegistry: any;
	loaderPlugins: {
